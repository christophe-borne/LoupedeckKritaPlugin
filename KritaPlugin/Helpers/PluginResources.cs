namespace Loupedeck.KritaPlugin
{
    ...
    internal static class PluginResources
    {
        ...
        // The parameter `folderName` must be specified as a full path, for example, `Loupedeck.KritaPlugin.Resources`.
        // Returns the full names of the resource files, for example, `Loupedeck.KritaPlugin.Resources.Resource.txt`.
