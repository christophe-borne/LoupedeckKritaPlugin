...
namespace Loupedeck.KritaPlugin
{
    ...
    public class ToolShapeEllipseCommand : PluginDynamicCommand
    {
        ...
        {
            return PluginResources.BitmapFromEmbaddedRessource("Loupedeck.KritaPlugin.images.Tools.ShapeEllipse.png");
        }
